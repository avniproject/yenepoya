...
create view yenepoya_hypertension_enrolment_view
            ("Ind.Id", "Ind.address_id", "Ind.uuid", "Ind.first_name", "Ind.last_name",
             ...
             "Enl.preference for food with excess salt",
...
SELECT
  ...
  single_select_coded(programEnrolment.observations->>'1341e326-d2b5-4cbc-b09a-108e10a84808')::TEXT as "Enl.Adherence to medications",
single_select_coded(programEnrolment.observations->>'644a912d-beb9-4140-a629-c6639b304e67')::TEXT as "Enl.Do you check your foot daily",
single_select_coded(programEnrolment.observations->>'d7e707f2-4c4e-47e8-8907-7dab7770fc89')::TEXT as "Enl.What about your physical activity",
single_select_coded(programEnrolment.observations->>'29e472b6-0478-4de5-89f9-d7a4a373ff42')::TEXT as "Enl.Alcohol use in last 1 year",
single_select_coded(programEnrolment.observations->>'ec3e201d-f4de-4705-b954-02c750ca5063')::TEXT as "Enl.What about the use of tobacco",
single_select_coded(programEnrolment.observations->>'182d8aef-512d-4d50-8fd8-95cb01f3ccbe')::TEXT as "Enl.Eating of fast foods like fried and bakery items weekly",
single_select_coded(programEnrolment.observations->>'fc5fb2db-c47c-43c3-9872-c64fd0ec23e4')::TEXT as "Enl.preference for food with excess salt",
single_select_coded(programEnrolment.observations->>'d31251b0-616a-47d5-84d6-7b5fad85baad')::TEXT as "Enl.Habit of vegetable intake atleast 3 servings daily",
single_select_coded(programEnrolment.observations->>'2ec1f0cb-1e3a-4c1e-be3b-a9790a9d832d')::TEXT as "Enl.Habit of fruit intake atleast 3 servings daily",
...
single_select_coded(programEnrolment.observations->>'8bc6db2a-388d-4028-a995-865ff018c8f6')::TEXT as "Enl.Whether your blood pressure is under control"
