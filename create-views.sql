...
create view yenepoya_household_survey_view as (
  SELECT individual.id                                                                                 "Ind.Id",
         ...
         multi_select_coded(
             encounter.observations -> '84b9db51-33ce-4da0-a5cc-5ea2058f95ad')::TEXT                as "Enc.Name the governemnt health facility preferred for chronic illness",
         ...
         multi_select_coded(
             encounter.observations -> '84a7b976-1730-479f-926a-dcdaac00b876')::TEXT                as "Enc.Name the Private Health facility preferred for acute illness",
         multi_select_coded(
             encounter.observations -> '3f04d17c-5652-452b-914f-77558049a306')::TEXT                as "Enc.Name the Private health facility preferred for chronic illness",
         multi_select_coded(
             encounter.observations -> '1d086e41-f08c-45a0-939c-6990f937370f')::TEXT                as "Enc.Name the government Health facility preferred for acute illness",
...
create view yenepoya_diabetes_followup_view as
SELECT individual.id                                                                            AS "Ind.Id",
       individual.address_id                                                                    AS "Ind.address_id",
       individual.uuid                                                                          AS "Ind.uuid",
       individual.first_name                                                                    AS "Ind.first_name",
...
SELECT individual.id                                                                                          "Ind.Id",
       ...
       single_select_coded(
           programEnrolment.observations ->> 'f386b688-c4e3-490f-968e-5746801ea5d4')::TEXT                 as "Enl.Received iron and folic acid tablets",
       single_select_coded(
           programEnrolment.observations ->> '25e79aeb-381b-4bfc-babb-3119d9b86349')::TEXT                 as "Enl.Received calcium tablet",
       single_select_coded(
           programEnrolment.observations ->> '7ed4f7b6-1740-4cec-86fa-992c1784ad41')::TEXT                 as "Enl.Received Albendazole tablet",

       single_select_coded(
           programEnrolment.observations ->> '52866745-30de-467f-b3c5-a4a7233ea4f0')::TEXT                 as "Enl.Consumed iron and folic acid tablets",
       single_select_coded(
           programEnrolment.observations ->> '9676380d-6c79-4c36-819b-3ace4ca41fb5')::TEXT                 as "Enl.Consumed calcium tablet",
       single_select_coded(
           programEnrolment.observations ->> '75672d5d-9444-410f-b0f5-e3c793aa69f4')::TEXT                 as "Enl.Consumed Albendazole tablet",
...
SELECT individual.id                                                                                          "Ind.Id",
       ...
       single_select_coded(
           programEncounter.observations ->> 'f386b688-c4e3-490f-968e-5746801ea5d4')::TEXT                 as "Enc.Received iron and folic acid tablets",
       single_select_coded(
           programEncounter.observations ->> '25e79aeb-381b-4bfc-babb-3119d9b86349')::TEXT                 as "Enc.Received calcium tablet",
       single_select_coded(
           programEncounter.observations ->> '7ed4f7b6-1740-4cec-86fa-992c1784ad41')::TEXT                 as "Enc.Received Albendazole tablet",
       ...
       single_select_coded(
           programEncounter.observations ->> '75672d5d-9444-410f-b0f5-e3c793aa69f4')::TEXT                 as "Enc.Consumed Albendazole tablet",
...
drop view if exists yenepoya_child_growth_followup_view;
